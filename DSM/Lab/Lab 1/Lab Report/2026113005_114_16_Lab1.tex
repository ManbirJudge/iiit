...
\fancyhead[L]{Lab 1 -- Report}
\fancyfoot[C]{\thepage}

\begin{document}

\begin{center}
    {\Large \textbf{Lab 1 -- Report}} \\[0.2cm]
...
\subsection{Aim}
Familiarization with Digital Test Kit and use it to check the working of NOT gate.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Connect Pin 14 ($V_{CC}$) to the power rail and Pin 7 ($\text{GND}$) to the ground rail.
        ...
        \item Toggle input switch S1 between HIGH and LOW logic levels and observing the LED indicator.
    \end{enumerate}
\end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Experimental Validation of NOT gate:} The experimental observations matched the theoretical truth table of NOT gate.
\end{itemize}
...
\begin{itemize}
    ...
    \item Write a program to output "ON" and "OFF" to serial monitor based on output of NOT gate.
\end{itemize}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Connect the power rail and ground rail of the Digital Test Kit to $\text{Vin}$ and $\text{GND}$ pins on the Arduino Uno to ensure a unified logic reference level.
        \item Connect output signal of the inverter to a digital input pin on the Arduino Uno board using a jumper wire.
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Write the code to read the output of NOT gate and output the corresponding logic state to the Serial Monitor.
    ...
    \begin{enumerate}
        \item Open the Serial Monitor inside the Arduino IDE.
...
\subsection{Conclusion}
We successfully configured the software environment to write, compile, and upload code to the Arduino Uno. The real-time readings captured on the Serial Monitor matched with the physical LED indicators and input switch states.
